      ...
      1: [
        function (e, t, n) {
          ...
          function u(e) {
            var t = o[e];
            return (
              t ? (t.lastIndex = 0) : (o[e] = t = new RegExp(r + e + i, 'g')), t
            );
          }
          t.exports = {
            add: function (e, t) {
      ...
      2: [
        function (e, t, n) {
          (function (r) {
            ...
            function ee(e, t) {
              var t =
                  (n = t).targetTouches && n.targetTouches.length
                    ? n.targetTouches[0]
            ...
            t.exports = function (e, t) {
              ...
              void 0 === y.moves && (y.moves = $),
                ...
                void 0 === y.ignoreInputTextSelection &&
                  (y.ignoreInputTextSelection = !0),
                ...
                if (i)
                  if (0 !== K(e)) {
                    if (
                      !(
                        void 0 !== e.clientX &&
                        Math.abs(e.clientX - o) <= (y.slideFactorX || 0) &&
                        void 0 !== e.clientY &&
                        Math.abs(e.clientY - r) <= (y.slideFactorY || 0)
                      )
                    ) {
              ...
              function S(e) {
                if (!((w.dragging && l) || u(e))) {
                  ...
                  if (n)
                    if (!y.invalid(e, t))
                      if (y.moves(e, n, t, Z(e))) return { item: e, source: n };
                }
              }
              function C(e) {
                var t, n;
                (t = e.item),
                  (n = e.source),
                  ('boolean' == typeof y.copy ? y.copy : y.copy(t, n)) &&
                    ((h = e.item.cloneNode(!0)),
              ...
              function L(e) {
                var t, n, o;
                w.dragging &&
                  ((t = 0 < arguments.length ? e : y.revertOnSpill),
                  !1 === (e = A((o = Q((n = h || s))))) &&
                    t &&
                    (h ? o && o.removeChild(h) : f.insertBefore(n, v)),
                  e || t
                    ? w.emit('cancel', n, f, f)
                    : w.emit('drop', n, o, f, p),
                  Y());
              ...
              function Y() {
                ...
                I(),
                  l &&
                    (j.rm(y.mirrorContainer, 'gu-unselectable'),
              ...
              function P(e) {
                if (l) {
                  ...
                  var i = h || s,
                    ...
                    u = null !== o && o !== g;
                  (!u && null !== o) ||
                    (g && a('out'), (g = o), u && a('over'));
                  r = Q(i);
                  if (o !== f || !h || y.copySortSource) {
                    var c,
                      e = D(o, e);
                    if (null !== e) c = F(o, e, t, n);
                    else {
              ...
              ((e = function (e, t, n) {
                return e.attachEvent(
                  ...
                  (function (e, t, n) {
                    ...
                    return (
                      a.push({ wrapper: o, element: e, type: t, fn: n }), o
                    );
                  })(e, t, n)
                );
              }),
                  ...
                  var o =
                    -1 === u.indexOf(t)
                      ...
                      : (function () {
                          var e;
                          c.createEvent
                            ? (e = c.createEvent('Event')).initEvent(t, !0, !0)
                            : c.createEventObject &&
                              (e = c.createEventObject());
                          return e;
                        })();
                  e.dispatchEvent
                    ? e.dispatchEvent(o)
